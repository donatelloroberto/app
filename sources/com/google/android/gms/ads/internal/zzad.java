...
public final class zzad {
    ...
    public final void zza(Context context, zzang zzang, boolean z, @Nullable zzajl zzajl, String str, @Nullable String str2, @Nullable Runnable runnable) {
        ...
        if (zzajl == null) {
            ...
            z2 = (((zzbv.zzer().currentTimeMillis() - zzajl.zzps()) > ((Long) zzkb.zzik().zzd(zznk.zzbcu)).longValue() ? 1 : ((zzbv.zzer().currentTimeMillis() - zzajl.zzps()) == ((Long) zzkb.zzik().zzd(zznk.zzbcu)).longValue() ? 0 : -1)) > 0) || !zzajl.zzpt();
        }
        if (!z2) {
            return;
        }
