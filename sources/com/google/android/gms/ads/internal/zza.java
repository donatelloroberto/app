...
public abstract class zza extends zzkt implements zzb, zzd, zzt, zzabm, zzadj, zzajs, zzjd {
    ...
    /* access modifiers changed from: protected */
    public abstract boolean zza(@Nullable zzajh zzajh, zzajh zzajh2);
    ...
    public void zzb(zzajh zzajh) {
        ...
        if (zzajh.errorCode != -2) {
            if (zzajh.errorCode == 3) {
                zzajh.zzcoq.zza(zzhu.zza.zzb.AD_FAILED_TO_LOAD_NO_FILL);
            } else {
                zzajh.zzcoq.zza(zzhu.zza.zzb.AD_FAILED_TO_LOAD);
            }
            zzi(zzajh.errorCode);
            return;
        }
    ...
    public void zzc(int i, boolean z) {
        zzakb.zzdk(new StringBuilder(30).append("Failed to load ad: ").append(i).toString());
        this.zzvu = z;
        if (this.zzvw.zzada != null) {
            try {
