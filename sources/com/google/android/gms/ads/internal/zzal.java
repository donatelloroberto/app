...
public final class zzal extends zzi implements zzai, zzz {
    ...
    private static zzaji zzb(zzaji zzaji) {
        try {
            ...
            return new zzaji(zzaji.zzcgs, new zzaej(zzaji.zzcgs, zzaej.zzbyq, zzaej.zzceo, Collections.emptyList(), Collections.emptyList(), zzaej.zzcep, true, zzaej.zzcer, Collections.emptyList(), zzaej.zzbsu, zzaej.orientation, zzaej.zzcet, zzaej.zzceu, zzaej.zzcev, zzaej.zzcew, zzaej.zzcex, (String) null, zzaej.zzcez, zzaej.zzare, zzaej.zzcdd, zzaej.zzcfa, zzaej.zzcfb, zzaej.zzamj, zzaej.zzarf, zzaej.zzarg, (zzaig) null, Collections.emptyList(), Collections.emptyList(), zzaej.zzcfh, zzaej.zzcfi, zzaej.zzcdr, zzaej.zzcds, zzaej.zzbsr, zzaej.zzbss, zzaej.zzcfj, (zzaiq) null, zzaej.zzcfl, zzaej.zzcfm, zzaej.zzced, zzaej.zzzl, 0, zzaej.zzcfp, Collections.emptyList(), zzaej.zzzm, zzaej.zzcfq), zzwy, zzaji.zzacv, zzaji.errorCode, zzaji.zzcoh, zzaji.zzcoi, (JSONObject) null, zzaji.zzcoq, (Boolean) null);
    ...
    public final void zzbq() {
        ...
        if (!(zzaji == null || zzaji.zzcos == null || !zzaji.zzcos.zzcfp || zzaqw == null || !zzbv.zzfa().zzi(this.zzvw.zzrt))) {
            this.zzwb = zzbv.zzfa().zza(new StringBuilder(23).append(this.zzvw.zzacr.zzcve).append(".").append(this.zzvw.zzacr.zzcvf).toString(), zzaqw.getWebView(), "", "javascript", zzbz());
