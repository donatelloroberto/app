...
public final class zzajr {
    ...
    private static boolean zzah(Context context) {
        int identifier = context.getResources().getIdentifier("Theme.Translucent", PushConstants.STYLE, "android");
        if (identifier == 0) {
    ...
    public final void zzb(com.google.android.gms.internal.ads.zzjj r11, long r12) {
        /*
            ...
            monitor-enter(r1)
            com.google.android.gms.internal.ads.zzajm r0 = com.google.android.gms.ads.internal.zzbv.zzeo()     // Catch:{ all -> 0x0061 }
            com.google.android.gms.internal.ads.zzakd r0 = r0.zzqh()     // Catch:{ all -> 0x0061 }
            long r2 = r0.zzrb()     // Catch:{ all -> 0x0061 }
            com.google.android.gms.common.util.Clock r0 = com.google.android.gms.ads.internal.zzbv.zzer()     // Catch:{ all -> 0x0061 }
            long r4 = r0.currentTimeMillis()     // Catch:{ all -> 0x0061 }
            long r6 = r10.zzcqe     // Catch:{ all -> 0x0061 }
            r8 = -1
            int r0 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r0 != 0) goto L_0x0064
            long r2 = r4 - r2
            com.google.android.gms.internal.ads.zzna<java.lang.Long> r0 = com.google.android.gms.internal.ads.zznk.zzayi     // Catch:{ all -> 0x0061 }
            com.google.android.gms.internal.ads.zzni r6 = com.google.android.gms.internal.ads.zzkb.zzik()     // Catch:{ all -> 0x0061 }
            java.lang.Object r0 = r6.zzd(r0)     // Catch:{ all -> 0x0061 }
            java.lang.Long r0 = (java.lang.Long) r0     // Catch:{ all -> 0x0061 }
            long r6 = r0.longValue()     // Catch:{ all -> 0x0061 }
        ...
        L_0x0038:
            ...
            long r2 = r10.zzcqe     // Catch:{ all -> 0x0061 }
            r10.zzcqd = r2     // Catch:{ all -> 0x0061 }
        L_0x003e:
            if (r11 == 0) goto L_0x0067
            android.os.Bundle r0 = r11.extras     // Catch:{ all -> 0x0061 }
            if (r0 == 0) goto L_0x0067
            android.os.Bundle r0 = r11.extras     // Catch:{ all -> 0x0061 }
            java.lang.String r2 = "gw"
            r3 = 2
            int r0 = r0.getInt(r2, r3)     // Catch:{ all -> 0x0061 }
            r2 = 1
        ...
        L_0x0052:
            com.google.android.gms.internal.ads.zzajm r0 = com.google.android.gms.ads.internal.zzbv.zzeo()     // Catch:{ all -> 0x0061 }
            com.google.android.gms.internal.ads.zzakd r0 = r0.zzqh()     // Catch:{ all -> 0x0061 }
            int r0 = r0.zzrc()     // Catch:{ all -> 0x0061 }
            r10.zzcqg = r0     // Catch:{ all -> 0x0061 }
            goto L_0x0038
        L_0x0061:
            r0 = move-exception
        ...
        L_0x0064:
            ...
            goto L_0x003e
        L_0x0067:
            int r0 = r10.zzcqf     // Catch:{ all -> 0x0061 }
            int r0 = r0 + 1
            r10.zzcqf = r0     // Catch:{ all -> 0x0061 }
            int r0 = r10.zzcqg     // Catch:{ all -> 0x0061 }
            int r0 = r0 + 1
            r10.zzcqg = r0     // Catch:{ all -> 0x0061 }
            int r0 = r10.zzcqg     // Catch:{ all -> 0x0061 }
            ...
            com.google.android.gms.internal.ads.zzajm r0 = com.google.android.gms.ads.internal.zzbv.zzeo()     // Catch:{ all -> 0x0061 }
            com.google.android.gms.internal.ads.zzakd r0 = r0.zzqh()     // Catch:{ all -> 0x0061 }
            r0.zzk((long) r4)     // Catch:{ all -> 0x0061 }
        L_0x0086:
            monitor-exit(r1)     // Catch:{ all -> 0x0061 }
            goto L_0x0051
        L_0x0088:
            com.google.android.gms.internal.ads.zzajm r0 = com.google.android.gms.ads.internal.zzbv.zzeo()     // Catch:{ all -> 0x0061 }
            com.google.android.gms.internal.ads.zzakd r0 = r0.zzqh()     // Catch:{ all -> 0x0061 }
            long r2 = r0.zzrd()     // Catch:{ all -> 0x0061 }
            long r2 = r4 - r2
            r10.zzcqh = r2     // Catch:{ all -> 0x0061 }
            goto L_0x0086
        */
