...
public final class zzaah {
    ...
    public final JSONObject zzng() {
        try {
            return new JSONObject().put(AdWebViewClient.SMS, this.zzbwr).put(AdWebViewClient.TELEPHONE, this.zzbws).put("calendar", this.zzbwt).put("storePicture", this.zzbwu).put("inlineVideo", this.zzbwv);
