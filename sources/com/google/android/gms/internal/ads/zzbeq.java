...
final class zzbeq extends zzben {
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        switch (i2) {
            ...
            case 2:
                return zzbem.zzf(i, (int) zzbek.zza(bArr, j), (int) zzbek.zza(bArr, 1 + j));
            default:
    ...
    public final int zzb(int r9, byte[] r10, int r11, int r12) {
        ...
        L_0x003b:
            ...
            r2 = 1
            long r2 = r2 + r4
            byte r1 = com.google.android.gms.internal.ads.zzbek.zza(r10, r4)
        ...
        L_0x004c:
            ...
            r6 = 1
            long r6 = r6 + r2
            byte r2 = com.google.android.gms.internal.ads.zzbek.zza(r10, r2)
        ...
        L_0x008b:
            ...
            r2 = 1
            long r6 = r4 + r2
            byte r2 = com.google.android.gms.internal.ads.zzbek.zza(r10, r4)
            r3 = -65
        ...
        L_0x00a9:
            r2 = 1
            long r2 = r2 + r6
            byte r1 = com.google.android.gms.internal.ads.zzbek.zza(r10, r6)
            r4 = -65
            if (r1 <= r4) goto L_0x0039
        L_0x00b4:
            r0 = -1
        ...
        L_0x00be:
            ...
            r2 = 1
            long r2 = r2 + r4
            byte r4 = com.google.android.gms.internal.ads.zzbek.zza(r10, r4)
            r5 = -65
            ...
            r4 = 1
            long r4 = r4 + r2
            byte r1 = com.google.android.gms.internal.ads.zzbek.zza(r10, r2)
            r2 = -65
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < 128 && j4 < j3) {
                j = 1 + j4;
                zzbek.zza(bArr, j4, (byte) charAt2);
            } else if (charAt2 < 2048 && j4 <= j3 - 2) {
                long j5 = j4 + 1;
                zzbek.zza(bArr, j4, (byte) ((charAt2 >>> 6) | 960));
                j = 1 + j5;
                zzbek.zza(bArr, j5, (byte) ((charAt2 & '?') | 128));
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j4 <= j3 - 3) {
                long j6 = 1 + j4;
                zzbek.zza(bArr, j4, (byte) ((charAt2 >>> 12) | 480));
                long j7 = 1 + j6;
                zzbek.zza(bArr, j6, (byte) (((charAt2 >>> 6) & 63) | 128));
                j = 1 + j7;
                zzbek.zza(bArr, j7, (byte) ((charAt2 & '?') | 128));
            } else if (j4 <= j3 - 4) {
                if (i3 + 1 != length) {
                    i3++;
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        long j9 = 1 + j8;
                        zzbek.zza(bArr, j8, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j10 = j9 + 1;
                        zzbek.zza(bArr, j9, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = 1 + j10;
                        zzbek.zza(bArr, j10, (byte) ((codePoint & 63) | 128));
                    }
                }
