...
public abstract class zzbbo<MessageType extends zzbbo<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzazy<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzbbo<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzazz<MessageType, BuilderType> {
        ...
        public final MessageType zzadi() {
            ...
            MessageType messagetype3 = (zzbbo) messagetype;
            boolean booleanValue = Boolean.TRUE.booleanValue();
            byte byteValue = ((Byte) messagetype3.zza(zze.zzdua, (Object) null, (Object) null)).byteValue();
            if (byteValue == 1) {
                z = true;
            } else if (byteValue == 0) {
                z = false;
            } else {
                boolean zzaa = zzbdg.zzaeo().zzab(messagetype3).zzaa(messagetype3);
                if (booleanValue) {
                    messagetype3.zza(zze.zzdub, (Object) zzaa ? messagetype3 : null, (Object) null);
                }
                z = zzaa;
            }
            if (z) {
        ...
        public final /* synthetic */ zzbcu zzadk() {
            ...
            if (byteValue == 1) {
                ...
                if (booleanValue) {
                    zzbbo.zza(zze.zzdub, (Object) zzaa ? zzbbo : null, (Object) null);
                }
                z = zzaa;
            }
            if (z) {
    ...
    protected static <T extends zzbbo<T, ?>> T zza(T t, zzbah zzbah) throws zzbbu {
        ...
        if (zza2 != null) {
            ...
            if (byteValue == 1) {
                ...
                boolean zzaa = zzbdg.zzaeo().zzab(zza2).zzaa(zza2);
                if (booleanValue) {
                    zza2.zza(zze.zzdub, (Object) zzaa ? zza2 : null, (Object) null);
                }
                z2 = zzaa;
            }
            if (!z2) {
        ...
        if (zza2 != null) {
            ...
            if (byteValue2 == 1) {
                ...
                boolean zzaa2 = zzbdg.zzaeo().zzab(zza2).zzaa(zza2);
                if (booleanValue2) {
                    zza2.zza(zze.zzdub, (Object) zzaa2 ? zza2 : null, (Object) null);
                }
                z = zzaa2;
            }
            if (!z) {
