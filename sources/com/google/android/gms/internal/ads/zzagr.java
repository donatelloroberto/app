...
public final class zzagr extends zzd implements zzahu {
    ...
    private static zzaji zzc(zzaji zzaji) {
        ...
        try {
            ...
            return new zzaji(zzaji.zzcgs, zzaji.zzcos, new zzwy(Arrays.asList(new zzwx[]{new zzwx(zzb.toString(), (String) null, Arrays.asList(new String[]{"com.google.ads.mediation.admob.AdMobAdapter"}), (String) null, (String) null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), jSONObject2, (String) null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), (String) null, (String) null, (String) null, (List<String>) null, (String) null, Collections.emptyList(), (String) null, -1)}), ((Long) zzkb.zzik().zzd(zznk.zzbao)).longValue(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), false, "", -1, 0, 1, (String) null, 0, -1, -1, false), zzaji.zzacv, zzaji.errorCode, zzaji.zzcoh, zzaji.zzcoi, zzaji.zzcob, zzaji.zzcoq, (Boolean) null);
        } catch (JSONException e) {
            zzakb.zzb("Unable to generate ad state for non-mediated rewarded video.", e);
            return new zzaji(zzaji.zzcgs, zzaji.zzcos, (zzwy) null, zzaji.zzacv, 0, zzaji.zzcoh, zzaji.zzcoi, zzaji.zzcob, zzaji.zzcoq, (Boolean) null);
        }
    }
