...
public final class zzxb implements zzxf {
    ...
    public final zzxq zzmj() {
        ...
        try {
            ...
            zzakb.zza(valueOf2.length() != 0 ? "Could not instantiate mediation adapter: ".concat(valueOf2) : new String("Could not instantiate mediation adapter: "), remoteException);
            return null;
        }
    }
