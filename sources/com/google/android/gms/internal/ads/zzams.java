...
public final class zzams {
    ...
    public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> zzdd(java.lang.String r15) {
        /*
            r14 = 21
            r2 = 0
            java.lang.Object r3 = zzcui
            monitor-enter(r3)
            java.util.Map<java.lang.String, java.util.List<java.util.Map<java.lang.String, java.lang.Object>>> r0 = zzcug     // Catch:{ all -> 0x00c1 }
        ...
        L_0x0017:
            return r0
        L_0x0018:
            java.lang.Object r1 = zzcui     // Catch:{ RuntimeException -> 0x009e, LinkageError -> 0x015e }
            monitor-enter(r1)     // Catch:{ RuntimeException -> 0x009e, LinkageError -> 0x015e }
            java.util.List<android.media.MediaCodecInfo> r0 = zzcuh     // Catch:{ all -> 0x009b }
        ...
        L_0x0020:
            ...
            java.util.List<android.media.MediaCodecInfo> r0 = zzcuh     // Catch:{ RuntimeException -> 0x009e, LinkageError -> 0x015e }
        ...
        L_0x009f:
            ...
            java.util.Map<java.lang.String, java.util.List<java.util.Map<java.lang.String, java.lang.Object>>> r1 = zzcug     // Catch:{ all -> 0x00c1 }
        ...
        L_0x00d6:
            ...
            java.util.List<android.media.MediaCodecInfo> r6 = zzcuh     // Catch:{ all -> 0x009b }
        ...
        L_0x015e:
            ...
            goto L_0x009f
        L_0x0161:
            java.util.Map<java.lang.String, java.util.List<java.util.Map<java.lang.String, java.lang.Object>>> r0 = zzcug     // Catch:{ RuntimeException -> 0x009e, LinkageError -> 0x015e }
            r0.put(r15, r1)     // Catch:{ RuntimeException -> 0x009e, LinkageError -> 0x015e }
            monitor-exit(r3)     // Catch:{ all -> 0x00c1 }
            r0 = r1
            goto L_0x0017
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzams.zzdd(java.lang.String):java.util.List");
    }
}
