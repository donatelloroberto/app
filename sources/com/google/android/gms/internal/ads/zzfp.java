...
public final class zzfp implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public final void zzm(int i) {
        if (this.zzagi.size() != 0 && this.zzagf != null) {
            ...
            boolean z5 = !z2 && zzbv.zzek().zza(view, this.zzaev, this.zzaew) && z3 && z4 && windowVisibility == 0;
            if (z && !this.zzadz.tryAcquire() && z5 == this.zzafd) {
                return;
            }
            if (z5 || this.zzafd || i != 1) {
                zzfs zzfs = new zzfs(zzbv.zzer().elapsedRealtime(), this.zzaev.isScreenOn(), view != null ? zzbv.zzem().isAttachedToWindow(view) : false, view != null ? view.getWindowVisibility() : 8, zza(this.zzafh), zza(rect), zza(rect2), z3, zza(rect3), z4, zza(rect4), this.zzagj.density, z5);
