...
public final class zzapu extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzapt {
    ...
    private final boolean zztk() {
        ...
        if (!(this.zzczr == null || this.zzczr == EGL10.EGL_NO_SURFACE)) {
            z = this.zzczo.eglMakeCurrent(this.zzczp, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT) | false | this.zzczo.eglDestroySurface(this.zzczp, this.zzczr);
            this.zzczr = null;
        }
        if (this.zzczq != null) {
    ...
    public final void run() {
            ...
            if (!this.zzczo.eglInitialize(this.zzczp, new int[2])) {
                ...
                if (eGLConfig == null) {
                    ...
                    if (this.zzczq == null || this.zzczq == EGL10.EGL_NO_CONTEXT) {
                        ...
                        this.zzczr = this.zzczo.eglCreateWindowSurface(this.zzczp, eGLConfig, this.zzczh, (int[]) null);
        ...
        this.zzczg = new SurfaceTexture(i);
        ...
        try {
            ...
            while (!this.zzczt) {
                ...
                if (this.zzczs) {
                    ...
                    zzdo("viewport");
                    int glGetUniformLocation = GLES20.glGetUniformLocation(this.zzczi, "uFOVx");
                    int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.zzczi, "uFOVy");
                    if (this.zzuq > this.zzur) {
                        GLES20.glUniform1f(glGetUniformLocation, 0.87266463f);
                        GLES20.glUniform1f(glGetUniformLocation2, (0.87266463f * ((float) this.zzur)) / ((float) this.zzuq));
                    } else {
                        GLES20.glUniform1f(glGetUniformLocation, (0.87266463f * ((float) this.zzuq)) / ((float) this.zzur));
