...
public final class zzayr {
    ...
    public final zzays zza(String str, byte[] bArr, byte[] bArr2, int i, zzayw zzayw) throws GeneralSecurityException {
        ...
        switch (zzayu.zzdnm[zzayw.ordinal()]) {
            case 1:
                byte[] bArr4 = new byte[((zzb * 2) + 1)];
                byte[] byteArray = w.getAffineX().toByteArray();
                byte[] byteArray2 = w.getAffineY().toByteArray();
                System.arraycopy(byteArray2, 0, bArr4, ((zzb * 2) + 1) - byteArray2.length, byteArray2.length);
            ...
            case 2:
                ...
                System.arraycopy(byteArray3, 0, bArr3, (zzb + 1) - byteArray3.length, byteArray3.length);
        ...
        zzek.init(new SecretKeySpec(zzek.doFinal(zza3), str));
