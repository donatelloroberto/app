...
public final class zzafa extends zzajx {
    ...
    private final JSONObject zza(zzaef zzaef, String str) {
        ...
        hashMap.put(PushConstants.PARSE_COM_DATA, bundle);
        if (info != null) {
    ...
    public final void zzdn() {
        ...
        zzaej zzc = zzc(zzaef);
        zzaef zzaef2 = zzaef;
        zzamu.zzsy.post(new zzafb(this, new zzaji(zzaef2, zzc, (zzwy) null, (zzjn) null, zzc.errorCode, zzbv.zzer().elapsedRealtime(), zzc.zzceu, (JSONObject) null, this.zzcci)));
    }
}
