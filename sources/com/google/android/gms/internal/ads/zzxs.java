...
public final class zzxs extends zzej implements zzxq {
    ...
    public final zzxz zzmo() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzyb = queryLocalInterface instanceof zzxz ? (zzxz) queryLocalInterface : new zzyb(readStrongBinder);
        }
        transactAndReadException.recycle();
        return zzyb;
    }
    ...
    public final zzyc zzmp() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzye = queryLocalInterface instanceof zzyc ? (zzyc) queryLocalInterface : new zzye(readStrongBinder);
        }
        transactAndReadException.recycle();
        return zzye;
    }
    ...
    public final zzyf zzmu() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzyh = queryLocalInterface instanceof zzyf ? (zzyf) queryLocalInterface : new zzyh(readStrongBinder);
        }
        transactAndReadException.recycle();
        return zzyh;
    }
