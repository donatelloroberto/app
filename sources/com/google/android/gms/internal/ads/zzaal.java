...
public class zzaal {
    ...
    public final void zzbw(String str) {
        try {
            this.zzbnd.zza("onError", new JSONObject().put(PushConstants.MESSAGE, str).put("action", this.zzbxf));
        } catch (JSONException e) {
    ...
    public final void zzby(String str) {
        try {
            this.zzbnd.zza("onStateChanged", new JSONObject().put(PushConstants.CHANNEL_STATE, str));
        } catch (JSONException e) {
