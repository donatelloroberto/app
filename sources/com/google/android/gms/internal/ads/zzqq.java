...
public final class zzqq extends zzej implements zzqo {
    ...
    public final zzps zzkf() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzpu = queryLocalInterface instanceof zzps ? (zzps) queryLocalInterface : new zzpu(readStrongBinder);
        }
        transactAndReadException.recycle();
        return zzpu;
    }
    ...
    public final zzpw zzkg() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzpy = queryLocalInterface instanceof zzpw ? (zzpw) queryLocalInterface : new zzpy(readStrongBinder);
        }
        transactAndReadException.recycle();
        return zzpy;
    }
