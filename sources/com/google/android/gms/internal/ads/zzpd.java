...
public class zzpd implements zzoz {
                ...
                if (view2 != null) {
                    ...
                    try {
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            jSONObject.put("x", zzv(zzn2[0] - zzn[0]));
                            jSONObject.put("y", zzv(zzn2[1] - zzn[1]));
                        ...
                        if (view2 instanceof TextView) {
                            ...
                            jSONObject3.put(PushConstants.STYLE_TEXT, textView.getText());
                        }
    ...
    private final void zza(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6) {
        ...
        try {
            ...
            jSONObject8.put(AppMeasurement.Param.TIMESTAMP, zzbv.zzer().currentTimeMillis());
    ...
    public zzaqw zzko() throws zzarg {
        ...
        if (!(this.zzbja == null || this.zzbja.optJSONObject("overlay") == null)) {
            ...
            zzaqw = zzarc.zza(context, zzasi.zzb(zzf), zzf.zzarb, false, false, this.zzbjc, this.zzyf, (zznx) null, (zzbo) null, (zzw) null, zzhs.zzhm());
            if (zzaqw != null) {
