...
final class zzacd implements Cloneable {
        ...
        try {
            ...
            if (this.value != null) {
                if (this.value instanceof zzacg) {
                    ...
                    while (true) {
                        int i3 = i;
                        if (i3 >= zzacgArr.length) {
                            break;
                        }
                        zzacgArr2[i3] = (zzacg) zzacgArr[i3].clone();
                        i = i3 + 1;
                    }
                }
            }
        ...
        if (this.value != null) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                if (Array.get(obj, i3) != null) {
                    i2 += zzacb.zzv(Array.get(obj, i3));
                }
            }
            return i2;
        }
        for (zzaci next : this.zzbxp) {
            i = next.zzbrm.length + zzaby.zzas(next.tag) + 0 + i;
        }
        return i;
    }
    ...
    public final void zza(zzaci zzaci) throws IOException {
        ...
        if (this.value instanceof zzacg) {
            ...
            zzi = (zzacg[]) Arrays.copyOf(zzacgArr2, zzacgArr2.length + zzacgArr.length);
            System.arraycopy(zzacgArr, 0, zzi, zzacgArr2.length, zzacgArr.length);
        } else {
            zzi = this.zzbxo.zzi(Collections.singletonList(zzaci));
        }
