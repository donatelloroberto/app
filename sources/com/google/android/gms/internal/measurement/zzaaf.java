...
final class zzaaf implements zzaay {
    ...
    private static boolean zza(zzaal zzaal) {
        return zzaal.zzuf() == zzzs.zzb.zzbsu;
    }

    private static zzaam zzub() {
        try {
            return (zzaam) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
        } catch (Exception e) {
            return zzbto;
        }
    }
    ...
    public final <T> zzaax<T> zzg(Class<T> cls) {
        ...
        if (zzzs.class.isAssignableFrom(cls)) {
            ...
            return zzaaq.zza(cls, zze, zzaau.zzuk(), zzaab.zzua(), zzaaz.zzup(), (zzzl<?>) null, zzaak.zzud());
        } else if (zza(zze)) {
            return zzaaq.zza(cls, zze, zzaau.zzuj(), zzaab.zztz(), zzaaz.zzun(), zzzn.zztq(), zzaak.zzuc());
        } else {
            return zzaaq.zza(cls, zze, zzaau.zzuj(), zzaab.zztz(), zzaaz.zzuo(), (zzzl<?>) null, zzaak.zzuc());
        }
    }
}
