...
public final class zzkm extends zzaca<zzkm> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzace.equals((Object[]) this.zzatd, (Object[]) zzkm.zzatd)) {
            return false;
        }
        if (!zzace.equals((Object[]) this.zzate, (Object[]) zzkm.zzate)) {
            return false;
        }
        if (!zzace.equals((Object[]) this.zzatf, (Object[]) zzkm.zzatf)) {
            return false;
        }
    ...
    public final int hashCode() {
        int i = 0;
        int hashCode = ((((((((this.zzatc == null ? 0 : this.zzatc.hashCode()) + (((this.zzadm == null ? 0 : this.zzadm.hashCode()) + (((this.zzatb == null ? 0 : this.zzatb.hashCode()) + ((getClass().getName().hashCode() + 527) * 31)) * 31)) * 31)) * 31) + zzace.hashCode((Object[]) this.zzatd)) * 31) + zzace.hashCode((Object[]) this.zzate)) * 31) + zzace.hashCode((Object[]) this.zzatf)) * 31;
