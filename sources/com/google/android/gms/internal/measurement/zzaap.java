...
final class zzaap {
    ...
    private static void zza(zzaan zzaan, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzfi(concat), zzzs.zza(method2, (Object) zzaan, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzfi(concat2), zzzs.zza(method3, (Object) zzaan, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzzs.zza(method4, (Object) zzaan, new Object[0]);
                    if (method5 == null) {
                        ...
                        booleanValue = ((Boolean) zzzs.zza(method5, (Object) zzaan, new Object[0])).booleanValue();
                    }
                    if (booleanValue) {
        ...
        if (zzaan instanceof zzzs.zza) {
            Iterator<Map.Entry<Object, Object>> it = ((zzzs.zza) zzaan).zzbsl.iterator();
            if (it.hasNext()) {
                it.next().getKey();
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"").append(zzabi.zza(zzyy.zzfg((String) obj))).append(Typography.quote);
            } else if (obj instanceof zzyy) {
                sb.append(": \"").append(zzabi.zza((zzyy) obj)).append(Typography.quote);
