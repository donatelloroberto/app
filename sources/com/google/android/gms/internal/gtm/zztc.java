...
class zztc<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final V put(K k, V v) {
        ...
        if (this.zzbdz.size() == this.zzbdy) {
            zztj remove = this.zzbdz.remove(this.zzbdy - 1);
    ...
    private final int zza(K k) {
        ...
        while (i <= i2) {
            int i3 = (i + i2) / 2;
            int compareTo2 = k.compareTo((Comparable) this.zzbdz.get(i3).getKey());
            if (compareTo2 < 0) {
                i2 = i3 - 1;
