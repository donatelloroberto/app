...
class zzqc extends zzqb {
    ...
    public final boolean equals(Object obj) {
        ...
        int zzne = zzne();
        int zzne2 = ((zzqc) obj).zzne();
        if (zzne == 0 || zzne2 == 0 || zzne == zzne2) {
            return zza((zzqc) obj, 0, size());
        }
        return false;
    }
    ...
    public final boolean zza(zzps zzps, int i, int i2) {
        if (i2 > zzps.size()) {
            ...
            throw new IllegalArgumentException(new StringBuilder(59).append("Ran off end of other: 0, ").append(i2).append(", ").append(zzps.size()).toString());
