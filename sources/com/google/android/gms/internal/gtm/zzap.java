...
public class zzap {
    ...
    private zzap(zzar zzar) {
        ...
        zzco.zzs(new StringBuilder(String.valueOf(str).length() + 134).append("Google Analytics ").append(str).append(" is starting up. To enable debug logging on a device run:\n  adb shell setprop log.tag.GAv4 DEBUG\n  adb logcat -s GAv4").toString());
    ...
    public final zzcm zzdf() {
        if (this.zzwn == null || !this.zzwn.isInitialized()) {
            return null;
        }
        return this.zzwn;
    }
