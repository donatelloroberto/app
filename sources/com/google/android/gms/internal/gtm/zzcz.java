...
public final class zzcz {
    ...
    public static String zzah(String str) {
        ...
        for (int i = 0; i < 11; i++) {
            if (!TextUtils.isEmpty(zzaf.get(strArr[i]))) {
                ...
                sb.append(strArr[i]).append("=").append(zzaf.get(strArr[i]));
            }
        }
        return sb.toString();
    }
    ...
    public static zzr zza(zzci zzci, String str) {
        ...
        try {
            ...
            Map<String, String> parse = HttpUtils.parse(new URI(valueOf.length() != 0 ? "?".concat(valueOf) : new String("?")), WebRequest.CHARSET_UTF_8);
            zzr zzr = new zzr();
