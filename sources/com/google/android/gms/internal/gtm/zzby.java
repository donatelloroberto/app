...
public final class zzby {
    ...
    public static zzbz<Integer> zzze = zzbz.zza("analytics.max_stored_hits", (int) CastStatusCodes.AUTHENTICATION_FAILED, 20000);
    private static zzbz<Integer> zzzf = zzbz.zza("analytics.max_stored_hits_per_app", (int) CastStatusCodes.AUTHENTICATION_FAILED, (int) CastStatusCodes.AUTHENTICATION_FAILED);
