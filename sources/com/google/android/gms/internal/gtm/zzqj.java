    ...
    static final class zze extends zzqj {
        ...
        public final void zzp(long j) throws IOException {
            ...
            while (this.zzaxd < this.zzaxb) {
                ...
                long j5 = this.zzaxd;
                this.zzaxd = j5 + 1;
                zztx.zza(j5, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzaxd), Long.valueOf(this.zzaxb), 1}));
        }
        ...
        public final void write(byte[] bArr, int i, int i2) throws IOException {
            if (bArr != null && i >= 0 && i2 >= 0 && bArr.length - i2 >= i && this.zzaxb - ((long) i2) >= this.zzaxd) {
                zztx.zza(bArr, (long) i, this.zzaxd, (long) i2);
                this.zzaxd += (long) i2;
            } else if (bArr == null) {
        ...
        public final void zzcz(String str) throws IOException {
            ...
            try {
                ...
                if (zzbd2 == zzbd) {
                    ...
                    zzay(position);
                    this.zzaxd = ((long) position) + this.zzaxd;
                    return;
                }
                ...
                zzy(this.zzaxd);
                zztz.zza(str, this.zzawy);
                this.zzaxd = ((long) zza) + this.zzaxd;
            } catch (zzud e) {
                this.zzaxd = j;
                zzy(this.zzaxd);
                zza(str, e);
