...
final class zzp implements Runnable {
    ...
    public final void run() {
        ...
        if ((this.zztk.equals("transaction") || this.zztk.equals("item")) || this.zztp.zzte.zzfm()) {
            ...
            String str3 = this.zzto;
            if (TextUtils.isEmpty((CharSequence) this.zzti.get("adid"))) {
                z = false;
            }
            this.zzti.put("_s", String.valueOf(this.zztp.zzcs().zza(new zzas(0, str2, str3, z, 0, hashMap))));
