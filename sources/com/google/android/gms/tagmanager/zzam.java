...
final class zzam extends zzbq {
    ...
    public final zzl zzb(Map<String, zzl> map) {
        ...
        try {
            ...
            zzdi.zzac(new StringBuilder(String.valueOf(zzc).length() + 34 + String.valueOf(message).length()).append("Custom macro/tag ").append(zzc).append(" threw exception ").append(message).toString());
            return zzgj.zzkc();
        }
    }
}
