...
final class zzbf extends RemoteMediaPlayer.zzb {
    ...
    zzbf(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, JSONObject jSONObject) {
    ...
    public final void zzb(zzct zzct) throws zzds {
        this.zzgb.zzfu.zza(this.zzgz, 0, -1, (MediaQueueItem[]) null, 1, (Integer) null, this.zzgg);
    }
}
