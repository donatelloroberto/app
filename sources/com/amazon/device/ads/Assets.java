...
class Assets {
    ...
    protected Assets(MobileAdsInfoStore infoStore2, FileHandlerFactory fileHandlerFactory2, Settings settings2, Metrics metrics2) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x0010, code lost:
        if (r11.baseFilePath == null) goto L_0x0012;
     */
    ...
    public synchronized boolean ensureAssetsCreated() {
        /*
            ...
            r4 = 0
            monitor-enter(r11)
            java.lang.String r6 = r11.baseFilePath     // Catch:{ all -> 0x0069 }
            if (r6 != 0) goto L_0x0014
            java.lang.String r6 = r11.getBaseFilePath()     // Catch:{ all -> 0x0069 }
        ...
        L_0x0012:
            ...
            return r4
        L_0x0014:
            long r2 = java.lang.System.nanoTime()     // Catch:{ all -> 0x0069 }
            com.amazon.device.ads.Settings r6 = r11.settings     // Catch:{ all -> 0x0069 }
            java.lang.String r7 = "mraid-assets-version"
            r8 = 0
            int r1 = r6.getInt(r7, r8)     // Catch:{ all -> 0x0069 }
            r0 = 0
            if (r1 >= r9) goto L_0x0045
            com.amazon.device.ads.MobileAdsLogger r6 = r11.logger     // Catch:{ all -> 0x0069 }
            java.lang.String r7 = "Writing assets to disk: version %d"
            r8 = 1
            java.lang.Object[] r8 = new java.lang.Object[r8]     // Catch:{ all -> 0x0069 }
            r9 = 0
            r10 = 5
            java.lang.Integer r10 = java.lang.Integer.valueOf(r10)     // Catch:{ all -> 0x0069 }
            r8[r9] = r10     // Catch:{ all -> 0x0069 }
            r6.d(r7, r8)     // Catch:{ all -> 0x0069 }
            boolean r6 = r11.writeAssetsToDisk()     // Catch:{ all -> 0x0069 }
            if (r6 == 0) goto L_0x005d
            com.amazon.device.ads.Settings r4 = r11.settings     // Catch:{ all -> 0x0069 }
            java.lang.String r6 = "mraid-assets-version"
            r7 = 5
            r4.putInt(r6, r7)     // Catch:{ all -> 0x0069 }
            r0 = 1
        L_0x0045:
            long r6 = java.lang.System.nanoTime()     // Catch:{ all -> 0x0069 }
            long r6 = r6 - r2
            long r2 = com.amazon.device.ads.NumberUtils.convertToMillisecondsFromNanoseconds(r6)     // Catch:{ all -> 0x0069 }
            com.amazon.device.ads.Metrics r4 = r11.metrics     // Catch:{ all -> 0x0069 }
            com.amazon.device.ads.MetricsCollector r6 = r4.getMetricsCollector()     // Catch:{ all -> 0x0069 }
            if (r0 == 0) goto L_0x006c
            com.amazon.device.ads.Metrics$MetricType r4 = com.amazon.device.ads.Metrics.MetricType.ASSETS_CREATED_LATENCY     // Catch:{ all -> 0x0069 }
        L_0x0058:
            r6.publishMetricInMilliseconds(r4, r2)     // Catch:{ all -> 0x0069 }
            r4 = r5
            goto L_0x0012
        L_0x005d:
            com.amazon.device.ads.Metrics r5 = r11.metrics     // Catch:{ all -> 0x0069 }
            com.amazon.device.ads.MetricsCollector r5 = r5.getMetricsCollector()     // Catch:{ all -> 0x0069 }
            com.amazon.device.ads.Metrics$MetricType r6 = com.amazon.device.ads.Metrics.MetricType.ASSETS_FAILED     // Catch:{ all -> 0x0069 }
        ...
        L_0x0069:
            ...
            throw r4
        L_0x006c:
            com.amazon.device.ads.Metrics$MetricType r4 = com.amazon.device.ads.Metrics.MetricType.ASSETS_ENSURED_LATENCY     // Catch:{ all -> 0x0069 }
            goto L_0x0058
        */
    ...
    private void writeAssetToDisk(CircuitBreaker breaker, byte[] bytes, String filename) {
        if (!breaker.isBroken()) {
            ...
            if (fileOutputHandler.open(FileOutputHandler.WriteMethod.OVERWRITE)) {
                try {
    ...
    /* access modifiers changed from: protected */
    public void writeBytesToOutputStream(OutputStream outputStream, byte[] bytes) throws IOException {
