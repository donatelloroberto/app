...
public class AdProperties {
    ...
    public enum AdType {
        ...
        private AdType(String type2) {
            this(r2, r3, type2, (String) null);
        }

        private AdType(String type2, String metricTag) {
            this.type = type2;
    ...
    AdProperties(org.json.JSONArray r9, com.amazon.device.ads.MobileAdsLoggerFactory r10) {
        /*
            ...
            com.amazon.device.ads.MobileAdsLogger r2 = r10.createMobileAdsLogger(r2)
            r8.logger = r2
        ...
        L_0x0016:
            ...
            int r2 = r9.getInt(r1)     // Catch:{ JSONException -> 0x002a }
            switch(r2) {
        ...
        L_0x002a:
            r0 = move-exception
            com.amazon.device.ads.MobileAdsLogger r2 = r8.logger
            java.lang.String r3 = "Unable to parse creative type: %s"
        ...
        L_0x003b:
            ...
            goto L_0x0023
        L_0x003f:
            com.amazon.device.ads.AdProperties$AdType r2 = com.amazon.device.ads.AdProperties.AdType.IMAGE_BANNER     // Catch:{ JSONException -> 0x002a }
            r8.adType_ = r2     // Catch:{ JSONException -> 0x002a }
            goto L_0x0023
        L_0x0044:
            com.amazon.device.ads.AdProperties$AdType r2 = com.amazon.device.ads.AdProperties.AdType.INTERSTITIAL     // Catch:{ JSONException -> 0x002a }
            r8.adType_ = r2     // Catch:{ JSONException -> 0x002a }
            goto L_0x0023
        L_0x0049:
            r2 = 1
            ...
            goto L_0x0023
        L_0x004d:
            com.amazon.device.ads.AdProperties$AdType r2 = com.amazon.device.ads.AdProperties.AdType.MRAID_1     // Catch:{ JSONException -> 0x002a }
            r8.adType_ = r2     // Catch:{ JSONException -> 0x002a }
            goto L_0x0023
        L_0x0052:
            com.amazon.device.ads.AdProperties$AdType r2 = com.amazon.device.ads.AdProperties.AdType.MRAID_2     // Catch:{ JSONException -> 0x002a }
            r8.adType_ = r2     // Catch:{ JSONException -> 0x002a }
            goto L_0x0023
        L_0x0057:
            return
