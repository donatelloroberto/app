...
class MRAIDAdSDKBridge implements AdSDKBridge {
    ...
    MRAIDAdSDKBridge(AdControlAccessor adControlAccessor2, JavascriptInteractor javascriptInteractor2) {
        this(adControlAccessor2, javascriptInteractor2, new PermissionChecker(), new MobileAdsLoggerFactory(), new WebRequest.WebRequestFactory(), ThreadUtils.getThreadRunner(), new GraphicsUtils(), new AlertDialogFactory(), new WebUtils2(), new AdUtils2());
    }

    MRAIDAdSDKBridge(AdControlAccessor adControlAccessor2, JavascriptInteractor javascriptInteractor2, PermissionChecker permissionChecker2, MobileAdsLoggerFactory loggerFactory, WebRequest.WebRequestFactory webRequestFactory2, ThreadUtils.ThreadRunner threadRunner2, GraphicsUtils graphicsUtils2, AlertDialogFactory alertDialogFactory2, WebUtils2 webUtils2, AdUtils2 adUtils2) {
    ...
    public void updateExpandProperties(int width, int height) {
        this.expandProperties.setWidth(width);
        this.expandProperties.setHeight(height);
    }

    /* access modifiers changed from: package-private */
    public void updateDefaultPosition(int width, int height, int offsetX, int offsetY) {
    ...
    public void setOrientationProperties(boolean allowOrientationChange, String forceOrientation) {
        ...
        if (!StringUtils.isNullOrEmpty(forceOrientation)) {
            try {
                ...
                this.logger.w("Not a valid orientation to force:" + forceOrientation);
            }
        }
    ...
    public void expand(String url) {
        if (this.adControlAccessor.isInterstitial()) {
            ...
            final ExpandProperties expandProperties2 = this.expandProperties;
            if (StringUtils.isNullOrWhiteSpace(url)) {
                expandAd(expandProperties2, (String) null);
                ...
                this.adControlAccessor.preloadUrl(url, new PreloadCallback() {
                    public void onPreloadComplete(String url) {
                        ...
                        MRAIDAdSDKBridge.this.expandAd(expandProperties2, url);
                    }
                });
            } else {
    ...
    public void playVideo(String url) {
        if (!this.adControlAccessor.isVisible()) {
            ...
            try {
                ...
                data.putString(ImagesContract.URL, url);
    ...
    public void open(String url) {
        ...
        if (this.webUtils.isUrlValid(url)) {
            ...
            if ("http".equals(scheme) || "https".equals(scheme)) {
                new InAppBrowser.InAppBrowserBuilder().withContext(getContext()).withExternalBrowserButton().withUrl(url).show();
            } else {
    ...
    private void createCalendarIntent(CalendarEventParameters parameters) {
        ...
        calendarIntent.putExtra(PushConstants.TITLE, parameters.getDescription());
        ...
        if (!StringUtils.isNullOrEmpty(parameters.getSummary())) {
            calendarIntent.putExtra(PushConstants.CHANNEL_DESCRIPTION, parameters.getSummary());
        }
    ...
    public void fetchPicture(String url) {
        ...
        try {
            WebRequest.WebResponse response = webRequest.makeCall();
            if (response == null) {
    ...
    public void savePicture(final Bitmap bitmap) {
        AlertDialog.Builder alert = this.alertDialogFactory.createBuilder(getContext());
        ...
        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                MediaScannerConnection.scanFile(MRAIDAdSDKBridge.this.getContext(), new String[]{insertUrl}, (String[]) null, (MediaScannerConnection.OnScanCompletedListener) null);
            }
        });
    ...
    private void lookupExpansionView() {
        ViewGroup adContainerView2;
        ViewGroup expansionView2;
        if (this.expansionView == null && (adContainerView2 = this.adControlAccessor.getViewParentIfExpanded()) != null && CONTENT_DESCRIPTION_AD_CONTAINER_VIEW.equals(adContainerView2.getContentDescription()) && (expansionView2 = (ViewGroup) adContainerView2.getParent()) != null && CONTENT_DESCRIPTION_EXPANSION_VIEW.equals(expansionView2.getContentDescription())) {
            this.expansionView = expansionView2;
        }
    }

    private Size computeExpandedSizeInPixels(ExpandProperties expandProperties2, String url) {
        Size maxSize = this.adControlAccessor.getMaxSize();
        int widthToCompute = (url == null || maxSize == null) ? expandProperties2.getWidth() : maxSize.getWidth();
        int heightToCompute = (url == null || maxSize == null) ? expandProperties2.getHeight() : maxSize.getHeight();
        this.logger.d("Expanding Ad to " + widthToCompute + "x" + heightToCompute);
    ...
    /* access modifiers changed from: package-private */
    public void expandAd(final ExpandProperties expandProperties2, final String url) {
        this.threadRunner.execute(new Runnable() {
            public void run() {
                MRAIDAdSDKBridge.this.expandAdOnThread(expandProperties2, url);
            }
        }, ThreadUtils.ExecutionStyle.RUN_ASAP, ThreadUtils.ExecutionThread.MAIN_THREAD);
    }
    ...
    /* access modifiers changed from: private */
    @SuppressLint({"InlinedApi"})
    public void expandAdOnThread(ExpandProperties expandProperties2, String url) {
        boolean z = true;
        if (url != null) {
        ...
        Size expandSize = computeExpandedSizeInPixels(expandProperties2, url);
        createExpandedView();
        ...
        if (expandProperties2.getUseCustomClose().booleanValue()) {
            z = false;
        }
        adControlAccessor2.enableCloseButton(z);
        this.rootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            private boolean triggered = false;
            ...
            public void onGlobalLayout() {
                if (!this.triggered) {
                    this.triggered = true;
                    MRAIDAdSDKBridge.this.logger.d("Expand ViewTreeObserver fired");
    ...
    public void resizeAd(final ResizeProperties resizeProperties2) {
        final Size resizeSize = computeResizeSizeInPixels(resizeProperties2);
        this.threadRunner.execute(new Runnable() {
            public void run() {
                MRAIDAdSDKBridge.this.resizeAdOnThread(resizeProperties2, resizeSize);
            }
        }, ThreadUtils.ExecutionStyle.RUN_ASAP, ThreadUtils.ExecutionThread.MAIN_THREAD);
    }

    /* access modifiers changed from: private */
    public void resizeAdOnThread(ResizeProperties resizeProperties2, Size resizeSize) {
        createResizedView();
        int leftMargin = this.adUtils.deviceIndependentPixelToPixel(this.defaultPosition.getX() + resizeProperties2.getOffsetX());
        int topMargin = this.adUtils.deviceIndependentPixelToPixel(this.defaultPosition.getY() + resizeProperties2.getOffsetY());
        RelativePosition closePosition = RelativePosition.fromString(resizeProperties2.getCustomClosePosition());
        Size maxSize = this.adControlAccessor.getMaxSize();
        ...
        if (!resizeProperties2.getAllowOffscreen().booleanValue()) {
    ...
    private static class GetCurrentPositionJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetCurrentPositionJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class GetDefaultPositionJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetDefaultPositionJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class GetMaxSizeJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetMaxSizeJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class GetScreenSizeJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetScreenSizeJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class GetPlacementTypeJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetPlacementTypeJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class SetOrientationPropertiesJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public SetOrientationPropertiesJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.setOrientationProperties(JSONUtils.getBooleanFromJSON(parameters, "allowOrientationChange", false), JSONUtils.getStringFromJSON(parameters, "forceOrientation", (String) null));
            return null;
        }
    }
    ...
    private static class GetExpandPropertiesJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetExpandPropertiesJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class SetExpandPropertiesJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public SetExpandPropertiesJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.setExpandProperties(JSONUtils.getIntegerFromJSON(parameters, "width", 0), JSONUtils.getIntegerFromJSON(parameters, "height", 0), JSONUtils.getBooleanFromJSON(parameters, "useCustomClose", false));
            return null;
        }
    }
    ...
    private static class GetResizePropertiesJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public GetResizePropertiesJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class SetResizePropertiesJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public SetResizePropertiesJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.setResizeProperties(JSONUtils.getIntegerFromJSON(parameters, "width", 0), JSONUtils.getIntegerFromJSON(parameters, "height", 0), JSONUtils.getIntegerFromJSON(parameters, "offsetX", 0), JSONUtils.getIntegerFromJSON(parameters, "offsetY", 0), JSONUtils.getStringFromJSON(parameters, "customClosePosition", (String) null), JSONUtils.getBooleanFromJSON(parameters, "allowOffscreen", false));
            return null;
        }
    }
    ...
    private static class UseCustomCloseJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public UseCustomCloseJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class CloseJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public CloseJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class ExpandJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public ExpandJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.expand(JSONUtils.getStringFromJSON(parameters, ImagesContract.URL, (String) null));
            return null;
        }
    }
    ...
    private static class ResizeJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public ResizeJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class PlayVideoJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public PlayVideoJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.playVideo(JSONUtils.getStringFromJSON(parameters, ImagesContract.URL, (String) null));
            return null;
        }
    }
    ...
    private static class OpenJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public OpenJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.open(JSONUtils.getStringFromJSON(parameters, ImagesContract.URL, (String) null));
            return null;
        }
    }
    ...
    private static class SupportsJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public SupportsJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }
    ...
    private static class CreateCalendarEventJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public CreateCalendarEventJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.createCalendarEvent(JSONUtils.getStringFromJSON(parameters, PushConstants.CHANNEL_DESCRIPTION, (String) null), JSONUtils.getStringFromJSON(parameters, FirebaseAnalytics.Param.LOCATION, (String) null), JSONUtils.getStringFromJSON(parameters, "summary", (String) null), JSONUtils.getStringFromJSON(parameters, "start", (String) null), JSONUtils.getStringFromJSON(parameters, "end", (String) null));
            return null;
        }
    }
    ...
    private static class StorePictureJSIF extends JavascriptInteractor.JavascriptMethodExecutor {
        ...
        public StorePictureJSIF(MRAIDAdSDKBridge bridge2) {
            super(name);
            this.bridge = bridge2;
        }

        public JSONObject execute(JSONObject parameters) {
            this.bridge.storePicture(JSONUtils.getStringFromJSON(parameters, ImagesContract.URL, (String) null));
            return null;
        }
    }
