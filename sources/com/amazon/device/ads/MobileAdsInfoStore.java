...
class MobileAdsInfoStore {
    ...
    public void setNoRetryTtl(int noRetryTtlSeconds) {
        int maxNoRetryTtlSeconds = this.debugProperties.getDebugPropertyAsInteger(DebugProperties.DEBUG_NORETRYTTL_MAX, 300000).intValue();
    ...
    public void setIsAppDisabled(boolean isAppDisabled2) {
        this.isAppDisabled = isAppDisabled2;
    }
