...
public class LoadingStarted implements Comparable<LoadingStarted>, SdkEvent {
    ...
    public LoadingStarted withBooleanValue(Boolean booleanValue2) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadingStarted)) {
            return false;
        }
        if (compareTo((LoadingStarted) o) != 0) {
            return false;
        }
        return true;
    }

    public int compareTo(LoadingStarted o) {
        if (o == null) {
            return 1;
        }
        if (o == this) {
