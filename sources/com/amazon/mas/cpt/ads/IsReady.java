...
public class IsReady implements Comparable<IsReady>, SdkEvent {
    ...
    public IsReady withBooleanValue(Boolean booleanValue2) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IsReady)) {
            return false;
        }
        if (compareTo((IsReady) o) != 0) {
            return false;
        }
        return true;
    }

    public int compareTo(IsReady o) {
        if (o == null) {
            return 1;
        }
        if (o == this) {
