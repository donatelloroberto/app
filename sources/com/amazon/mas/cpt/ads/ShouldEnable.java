...
public class ShouldEnable implements Comparable<ShouldEnable>, SdkEvent {
    ...
    public ShouldEnable withBooleanValue(Boolean booleanValue2) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShouldEnable)) {
            return false;
        }
        if (compareTo((ShouldEnable) o) != 0) {
            return false;
        }
        return true;
    }

    public int compareTo(ShouldEnable o) {
        if (o == null) {
            return 1;
        }
        if (o == this) {
