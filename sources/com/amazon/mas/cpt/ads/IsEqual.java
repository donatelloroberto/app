...
public class IsEqual implements Comparable<IsEqual>, SdkEvent {
    ...
    public IsEqual withBooleanValue(Boolean booleanValue2) {
    ...
    public boolean equals(Object o) {
        ...
        if (compareTo((IsEqual) o) != 0) {
            return false;
        }
        return true;
    }

    public int compareTo(IsEqual o) {
        if (o == null) {
            return 1;
        }
        if (o == this) {
