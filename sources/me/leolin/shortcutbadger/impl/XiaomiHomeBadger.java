...
public class XiaomiHomeBadger implements Badger {
    ...
    public void executeBadge(Context context, ComponentName componentName, int badgeCount) throws ShortcutBadgeException {
        ...
        try {
            ...
            if (badgeCount == 0) {
                ...
                valueOf = Integer.valueOf(badgeCount);
            }
            try {
                field.set(miuiNotification, String.valueOf(valueOf));
            } catch (Exception e) {
    ...
    private void tryNewMiuiBadge(Context context, int badgeCount) throws ShortcutBadgeException {
        ...
        if (this.resolveInfo != null) {
            ...
            Notification notification = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.resolveInfo.getIconResource()).build();
            try {
