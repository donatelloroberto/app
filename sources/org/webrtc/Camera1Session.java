...
class Camera1Session implements CameraSession {
    ...
    public static void create(CameraSession.CreateSessionCallback callback, CameraSession.Events events2, boolean captureToTexture2, Context applicationContext2, SurfaceTextureHelper surfaceTextureHelper2, MediaRecorder mediaRecorder, int cameraId2, int width, int height, int framerate) {
        ...
        Logging.d(TAG, "Open camera " + cameraId2);
        ...
        try {
            ...
            try {
                ...
                CameraEnumerationAndroid.CaptureFormat captureFormat2 = findClosestCaptureFormat(parameters, width, height, framerate);
                updateCameraParameters(camera2, parameters, captureFormat2, findClosestPictureSize(parameters, width, height), captureToTexture2);
                ...
                callback.onDone(new Camera1Session(events2, captureToTexture2, applicationContext2, surfaceTextureHelper2, mediaRecorder, cameraId2, camera2, info2, captureFormat2, constructionTimeNs2));
            } catch (IOException e) {
                camera2.release();
