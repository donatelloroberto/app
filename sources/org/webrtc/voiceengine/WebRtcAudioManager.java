...
public class WebRtcAudioManager {
    ...
    WebRtcAudioManager(long nativeAudioManager2) {
        ...
        nativeCacheAudioParameters(this.sampleRate, this.outputChannels, this.inputChannels, this.hardwareAEC, this.hardwareAGC, this.hardwareNS, this.lowLatencyOutput, this.lowLatencyInput, this.proAudio, this.outputBufferSize, this.inputBufferSize, nativeAudioManager2);
    }

    private boolean init() {
        Logging.d(TAG, PushConstants.INITIALIZE + WebRtcAudioUtils.getThreadInfo());
        if (!this.initialized) {
