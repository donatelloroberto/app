...
public class MediaCodecVideoDecoder {
    ...
    public static boolean isH264HighProfileHwSupported() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (findDecoder(H264_MIME_TYPE, new String[]{supportedQcomH264HighProfileHwCodecPrefix}) != null) {
                return true;
            }
        }
        ...
        if (findDecoder(H264_MIME_TYPE, new String[]{supportedExynosH264HighProfileHwCodecPrefix}) != null) {
            return true;
        }
        return false;
    }
