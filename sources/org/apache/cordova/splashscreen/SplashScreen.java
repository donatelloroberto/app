...
public class SplashScreen extends CordovaPlugin {
    ...
    private int getSplashId() {
        ...
        int drawableId = this.f5cordova.getActivity().getResources().getIdentifier(splashResource, PushConstants.DRAWABLE, this.f5cordova.getActivity().getClass().getPackage().getName());
        if (drawableId == 0) {
            return this.f5cordova.getActivity().getResources().getIdentifier(splashResource, PushConstants.DRAWABLE, this.f5cordova.getActivity().getPackageName());
        }
        return drawableId;
    }
    ...
    public void pluginInitialize() {
        if (!HAS_BUILT_IN_SPLASH_SCREEN) {
            ...
            this.orientation = this.f5cordova.getActivity().getResources().getConfiguration().orientation;
            if (firstShow) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation != this.orientation) {
            ...
            if (this.splashImageView != null && (drawableId = getSplashId()) != 0) {
                this.splashImageView.setImageDrawable(this.f5cordova.getActivity().getResources().getDrawable(drawableId));
            }
        }
    }
    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        ...
        if (!this.f5cordova.getActivity().isFinishing()) {
            ...
            if (splashscreenTime > 0 || !hideAfterDelay) {
                this.f5cordova.getActivity().runOnUiThread(new Runnable() {
                    public void run() {
                        Display display = SplashScreen.this.f5cordova.getActivity().getWindowManager().getDefaultDisplay();
                        ...
                        if ((SplashScreen.this.f5cordova.getActivity().getWindow().getAttributes().flags & 1024) == 1024) {
    ...
    public void spinnerStart() {
        this.f5cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                RelativeLayout centeredLayout = new RelativeLayout(SplashScreen.this.f5cordova.getActivity());
                ...
                if (Build.VERSION.SDK_INT >= 21 && (colorName = SplashScreen.this.preferences.getString("SplashScreenSpinnerColor", (String) null)) != null) {
