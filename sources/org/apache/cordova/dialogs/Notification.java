...
public class Notification extends CordovaPlugin {
    ...
    public void beep(final long count) {
        this.f5cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                Ringtone notification = RingtoneManager.getRingtone(Notification.this.f5cordova.getActivity().getBaseContext(), RingtoneManager.getDefaultUri(2));
    ...
    public synchronized void alert(String message, String title, String buttonLabel, CallbackContext callbackContext) {
        final CordovaInterface cordova2 = this.f5cordova;
    ...
    public synchronized void prompt(String message, String title, JSONArray buttonLabels, String defaultText, CallbackContext callbackContext) {
        ...
        this.f5cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                promptInput.setTextColor(cordova2.getActivity().getResources().getColor(17170435));
                promptInput.setText(str);
                AlertDialog.Builder dlg = Notification.this.createDialog(cordova2);
                dlg.setMessage(str2);
                dlg.setTitle(str3);
                dlg.setCancelable(true);
                        ...
                        dlg.setNegativeButton(jSONArray.getString(0), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.d(Notification.LOG_TAG, "JSONException on first button.", (Throwable) e);
                                }
                        ...
                        dlg.setNeutralButton(jSONArray.getString(1), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.d(Notification.LOG_TAG, "JSONException on second button.", (Throwable) e);
                                }
                                callbackContext2.sendPluginResult(new PluginResult(PluginResult.Status.OK, result));
                            }
                        });
                        ...
                        dlg.setPositiveButton(jSONArray.getString(2), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    LOG.d(Notification.LOG_TAG, "JSONException on third button.", (Throwable) e);
                                }
                                callbackContext2.sendPluginResult(new PluginResult(PluginResult.Status.OK, result));
                            }
                        });
