...
public class NetworkManager extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        try {
            connectionType = getConnectionInfo(this.sockMan.getActiveNetworkInfo()).get(AppMeasurement.Param.TYPE).toString();
    ...
    public void updateConnectionInfo(NetworkInfo info) {
        ...
        if (!thisInfo.equals(this.lastInfo)) {
            String connectionType = "";
            try {
                connectionType = thisInfo.get(AppMeasurement.Param.TYPE).toString();
            } catch (JSONException e) {
                LOG.d(LOG_TAG, e.getLocalizedMessage());
            }
    ...
    private JSONObject getConnectionInfo(NetworkInfo info) {
        ...
        try {
            connectionInfo.put(AppMeasurement.Param.TYPE, type);
