...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    public CordovaInterface f6cordova;
    ...
    public void init(CordovaInterface cordova2, List<PluginEntry> pluginEntries, CordovaPreferences preferences2) {
        if (this.f6cordova != null) {
            throw new IllegalStateException();
        }
        this.f6cordova = cordova2;
        this.preferences = preferences2;
        this.pluginManager = new PluginManager(this, this.f6cordova, pluginEntries);
        ...
        final Runnable loadError = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    data.put(PushConstants.CHANNEL_DESCRIPTION, "The connection to the server was unsuccessful.");
        ...
        final Runnable timeoutCheck = new Runnable() {
            public void run() {
                ...
                if (CordovaWebViewImpl.this.loadUrlTimeout == currentLoadUrlTimeout) {
                    CordovaWebViewImpl.this.f6cordova.getActivity().runOnUiThread(loadError);
                }
            }
        };
        final boolean _recreatePlugins = recreatePlugins2;
        final String str = url;
        this.f6cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                if (loadUrlTimeoutValue > 0) {
                    CordovaWebViewImpl.this.f6cordova.getThreadPool().execute(timeoutCheck);
                }
    ...
    public void showWebPage(String url, boolean openExternal, boolean clearHistory, Map<String, Object> map) {
        ...
        try {
            ...
            LOG.e(TAG, "Error loading url " + url, (Throwable) e);
        }
    }
    ...
    protected class EngineClient implements CordovaWebViewEngine.Client {
        ...
        public void onReceivedError(int errorCode, String description, String failingUrl) {
            ...
            try {
                ...
                data.put(PushConstants.CHANNEL_DESCRIPTION, description);
            ...
            if (CordovaWebViewImpl.this.engine.getView().getVisibility() != 0) {
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            Thread.sleep(2000);
                            CordovaWebViewImpl.this.f6cordova.getActivity().runOnUiThread(new Runnable() {
                                public void run() {
