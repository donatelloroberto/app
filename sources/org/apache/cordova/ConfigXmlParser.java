    ...
    public void handleStartTag(XmlPullParser xml) {
        ...
        if (strNode.equals("feature")) {
            ...
            if (this.paramType.equals(NotificationCompat.CATEGORY_SERVICE)) {
                this.service = xml.getAttributeValue((String) null, FirebaseAnalytics.Param.VALUE);
            } else if (this.paramType.equals("package") || this.paramType.equals("android-package")) {
                this.pluginClass = xml.getAttributeValue((String) null, FirebaseAnalytics.Param.VALUE);
            } else if (this.paramType.equals("onload")) {
                this.onload = "true".equals(xml.getAttributeValue((String) null, FirebaseAnalytics.Param.VALUE));
            }
        } else if (strNode.equals("preference")) {
            this.prefs.set(xml.getAttributeValue((String) null, "name").toLowerCase(Locale.ENGLISH), xml.getAttributeValue((String) null, FirebaseAnalytics.Param.VALUE));
        } else if (strNode.equals(FirebaseAnalytics.Param.CONTENT) && (src = xml.getAttributeValue((String) null, "src")) != null) {
            setStartUrl(src);
        }
    }
