...
final class MapWithDefaultImpl<K, V> implements MapWithDefault<K, V> {
    ...
    public MapWithDefaultImpl(@NotNull Map<K, ? extends V> map2, @NotNull Function1<? super K, ? extends V> function1) {
        ...
        Intrinsics.checkParameterIsNotNull(function1, PushConstants.SOUND_DEFAULT);
        this.map = map2;
    ...
    public V getOrImplicitDefault(K key) {
        ...
        return (value$iv != null || $receiver$iv.containsKey(key)) ? value$iv : this.f1default.invoke(key);
    }
}
