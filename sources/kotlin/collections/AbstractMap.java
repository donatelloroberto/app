...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public boolean containsValue(Object value) {
        Iterable<Map.Entry> $receiver$iv = entrySet();
        if (($receiver$iv instanceof Collection) && ((Collection) $receiver$iv).isEmpty()) {
            return false;
        }
        for (Map.Entry it : $receiver$iv) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v1, resolved type: java.util.Map$Entry<K, V>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v2, resolved type: java.util.Map$Entry<K, V>} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: java.util.Map$Entry<K, V>} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final java.util.Map.Entry<K, V> implFindEntry(K r6) {
        /*
            r5 = this;
    ...
    public static final class Companion {
        ...
        public final boolean entryEquals$kotlin_stdlib(@NotNull Map.Entry<?, ?> e, @Nullable Object other) {
            ...
            return Intrinsics.areEqual((Object) e.getKey(), ((Map.Entry) other).getKey()) && Intrinsics.areEqual((Object) e.getValue(), ((Map.Entry) other).getValue());
        }
    }
}
