...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String trimStart(@NotNull String $receiver, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (true) {
            if (i >= length) {
                break;
            } else if (!predicate.invoke(Character.valueOf($receiver$iv.charAt(i))).booleanValue()) {
    ...
    public static final String trimEnd(@NotNull String $receiver, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (true) {
            if (length < 0) {
                break;
            } else if (!predicate.invoke(Character.valueOf($receiver$iv.charAt(length))).booleanValue()) {
                charSequence = $receiver$iv.subSequence(0, length + 1);
                break;
            } else {
                length--;
            }
    ...
    public static final CharSequence trim(@NotNull CharSequence $receiver, @NotNull char... chars) {
        ...
        while (startIndex$iv <= endIndex$iv) {
            ...
            boolean match$iv = ArraysKt.contains(chars, $receiver$iv.charAt(index$iv));
            if (!startFound$iv) {
                if (!match$iv) {
                    startFound$iv = true;
                } else {
    ...
    public static final String trim(@NotNull String $receiver, @NotNull char... chars) {
        ...
        while (startIndex$iv$iv <= endIndex$iv$iv) {
            ...
            boolean match$iv$iv = ArraysKt.contains(chars, $receiver$iv$iv.charAt(index$iv$iv));
            if (!startFound$iv$iv) {
                if (!match$iv$iv) {
    ...
    public static final CharSequence trimStart(@NotNull CharSequence $receiver, @NotNull char... chars) {
        ...
        int length = $receiver$iv.length();
        for (int i = 0; i < length; i++) {
            if (!ArraysKt.contains(chars, $receiver$iv.charAt(i))) {
    ...
    public static final String trimStart(@NotNull String $receiver, @NotNull char... chars) {
        ...
        while (true) {
            if (i >= length) {
                break;
            } else if (!ArraysKt.contains(chars, $receiver$iv$iv.charAt(i))) {
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence $receiver, @NotNull char... chars) {
        ...
        Intrinsics.checkParameterIsNotNull(chars, "chars");
        CharSequence $receiver$iv = $receiver;
        for (int length = $receiver$iv.length() - 1; length >= 0; length--) {
            if (!ArraysKt.contains(chars, $receiver$iv.charAt(length))) {
                return $receiver$iv.subSequence(0, length + 1);
            }
        }
        return "";
    }
    ...
    public static final String trimEnd(@NotNull String $receiver, @NotNull char... chars) {
        ...
        while (true) {
            if (length < 0) {
                break;
            } else if (!ArraysKt.contains(chars, $receiver$iv$iv.charAt(length))) {
                charSequence = $receiver$iv$iv.subSequence(0, length + 1);
                break;
            } else {
                length--;
            }
    ...
    public static final CharSequence trim(@NotNull CharSequence $receiver) {
        ...
        while (startIndex$iv <= endIndex$iv) {
            ...
            boolean match$iv = CharsKt.isWhitespace($receiver$iv.charAt(index$iv));
            if (!startFound$iv) {
                if (!match$iv) {
                    startFound$iv = true;
                } else {
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence $receiver) {
        ...
        CharSequence $receiver$iv = $receiver;
        for (int length = $receiver$iv.length() - 1; length >= 0; length--) {
            if (!CharsKt.isWhitespace($receiver$iv.charAt(length))) {
                return $receiver$iv.subSequence(0, length + 1);
            }
        }
        return "";
    ...
    public static final String substringBefore(@NotNull String $receiver, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        String missingDelimiterValue2 = $receiver.substring(0, index);
    ...
    public static final String substringAfter(@NotNull String $receiver, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        String missingDelimiterValue2 = $receiver.substring(index + 1, $receiver.length());
        Intrinsics.checkExpressionValueIsNotNull(missingDelimiterValue2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
        return missingDelimiterValue2;
    }
    ...
    public static final String substringAfter(@NotNull String $receiver, @NotNull String delimiter, @NotNull String missingDelimiterValue) {
        ...
        String missingDelimiterValue2 = $receiver.substring(delimiter.length() + index, $receiver.length());
        Intrinsics.checkExpressionValueIsNotNull(missingDelimiterValue2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
        return missingDelimiterValue2;
    }
    ...
    public static final String removePrefix(@NotNull String $receiver, @NotNull CharSequence prefix) {
        ...
        String $receiver2 = $receiver.substring(prefix.length());
    ...
    public static final String removeSuffix(@NotNull String $receiver, @NotNull CharSequence suffix) {
        ...
        String $receiver2 = $receiver.substring(0, $receiver.length() - suffix.length());
    ...
    public static final String removeSurrounding(@NotNull String $receiver, @NotNull CharSequence prefix, @NotNull CharSequence suffix) {
        ...
        String $receiver2 = $receiver.substring(prefix.length(), $receiver.length() - suffix.length());
        Intrinsics.checkExpressionValueIsNotNull($receiver2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
        return $receiver2;
    }
    ...
    public static final String replaceAfter(@NotNull String $receiver, char delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        int length = $receiver.length();
        return StringsKt.replaceRange((CharSequence) $receiver, index + 1, length, (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfter(@NotNull String $receiver, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        int length = $receiver.length();
        return StringsKt.replaceRange((CharSequence) $receiver, delimiter.length() + index, length, (CharSequence) replacement).toString();
    }
    ...
    public static final boolean regionMatchesImpl(@NotNull CharSequence $receiver, int thisOffset, @NotNull CharSequence other, int otherOffset, int length, boolean ignoreCase) {
        ...
        for (int i = 0; i < length; i++) {
            if (!CharsKt.equals($receiver.charAt(thisOffset + i), other.charAt(otherOffset + i), ignoreCase)) {
                return false;
            }
        }
        return true;
    ...
    public static final int indexOfAny(@NotNull CharSequence $receiver, @NotNull char[] chars, int startIndex, boolean ignoreCase) {
        ...
        if (ignoreCase || chars.length != 1 || !($receiver instanceof String)) {
            ...
            if (coerceAtLeast <= lastIndex) {
                while (true) {
                    char charAtIndex = $receiver.charAt(coerceAtLeast);
                    ...
                    while (true) {
                        if (i >= length) {
                            z = false;
                            break;
                        } else if (CharsKt.equals($receiver$iv[i], charAtIndex, ignoreCase)) {
                            z = true;
                            break;
                        } else {
                            i++;
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence $receiver, @NotNull char[] chars, int startIndex, boolean ignoreCase) {
        ...
        Intrinsics.checkParameterIsNotNull(chars, "chars");
        if (ignoreCase || chars.length != 1 || !($receiver instanceof String)) {
            for (int coerceAtMost = RangesKt.coerceAtMost(startIndex, StringsKt.getLastIndex($receiver)); coerceAtMost >= 0; coerceAtMost--) {
                char charAtIndex = $receiver.charAt(coerceAtMost);
                char[] $receiver$iv = chars;
                int length = $receiver$iv.length;
                int i = 0;
                while (true) {
    ...
    private static final int indexOf$StringsKt__StringsKt(@NotNull CharSequence $receiver, CharSequence other, int startIndex, int endIndex, boolean ignoreCase, boolean last) {
        ...
        if (!($receiver instanceof String) || !(other instanceof String)) {
            ...
            if (step <= 0 ? first >= last2 : first <= last2) {
                while (true) {
                    if (!StringsKt.regionMatchesImpl(other, 0, $receiver, first, other.length(), ignoreCase)) {
                        if (first == last2) {
                            break;
                        }
                        first += step;
            ...
            if (step2 <= 0 ? first2 >= last3 : first2 <= last3) {
                while (!StringsKt.regionMatches((String) other, 0, (String) $receiver, first2, other.length(), ignoreCase)) {
                    if (first2 != last3) {
                        first2 += step2;
                    }
                }
    ...
    public static final kotlin.Pair<java.lang.Integer, java.lang.String> findAnyOf$StringsKt__StringsKt(@org.jetbrains.annotations.NotNull java.lang.CharSequence r17, java.util.Collection<java.lang.String> r18, int r19, boolean r20, boolean r21) {
        /*
            ...
            java.lang.Object r2 = kotlin.collections.CollectionsKt.single(r18)
            ...
            r1 = r17
            r3 = r19
            int r12 = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) r1, (java.lang.String) r2, (int) r3, (boolean) r4, (int) r5, (java.lang.Object) r6)
        L_0x001e:
        ...
        L_0x0022:
            ...
            r1 = r17
            r3 = r19
            int r12 = kotlin.text.StringsKt.lastIndexOf$default((java.lang.CharSequence) r1, (java.lang.String) r2, (int) r3, (boolean) r4, (int) r5, (java.lang.Object) r6)
            goto L_0x001e
        L_0x002e:
        ...
        L_0x0037:
            ...
            r1 = 0
            r0 = r19
            int r4 = kotlin.ranges.RangesKt.coerceAtLeast((int) r0, (int) r1)
        ...
        L_0x006b:
            ...
            int r7 = r3.length()
            r8 = r20
            boolean r4 = kotlin.text.StringsKt.regionMatches((java.lang.String) r3, (int) r4, (java.lang.String) r5, (int) r6, (int) r7, (boolean) r8)
        ...
        L_0x008a:
            ...
            goto L_0x0021
        L_0x0097:
            int r1 = kotlin.text.StringsKt.getLastIndex(r17)
            r0 = r19
            int r1 = kotlin.ranges.RangesKt.coerceAtMost((int) r0, (int) r1)
            r4 = 0
            kotlin.ranges.IntProgression r13 = kotlin.ranges.RangesKt.downTo((int) r1, (int) r4)
            goto L_0x004c
        L_0x00a7:
    ...
    public static final boolean contains(@NotNull CharSequence $receiver, @NotNull CharSequence other, boolean ignoreCase) {
        ...
        if (other instanceof String) {
            return StringsKt.indexOf$default($receiver, (String) other, 0, ignoreCase, 2, (Object) null) >= 0;
        }
        return indexOf$StringsKt__StringsKt$default($receiver, other, 0, $receiver.length(), ignoreCase, false, 16, (Object) null) >= 0;
    }
    ...
    public static final List<String> split(@NotNull CharSequence $receiver, @NotNull String[] delimiters, boolean ignoreCase, int limit) {
        ...
        for (IntRange substring : $receiver$iv) {
            destination$iv$iv.add(StringsKt.substring($receiver, substring));
        }
