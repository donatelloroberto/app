...
final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(@NotNull CharSequence input2, int startIndex2, int limit2, @NotNull Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> getNextMatch2) {
