...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(long $receiver) {
        long j = (long) 127;
        if (((long) -128) <= $receiver && j >= $receiver) {
    ...
    public static final Byte toByteExactOrNull(double $receiver) {
        double d = (double) 127;
        if ($receiver < ((double) -128) || $receiver > d) {
            return null;
        }
        return Byte.valueOf((byte) ((int) $receiver));
    }
    ...
    public static final Byte toByteExactOrNull(float $receiver) {
        float f = (float) 127;
        if ($receiver < ((float) -128) || $receiver > f) {
            return null;
        }
        return Byte.valueOf((byte) ((int) $receiver));
    }
    ...
    public static final Integer toIntExactOrNull(long $receiver) {
        ...
        if (((long) Integer.MIN_VALUE) <= $receiver && j >= $receiver) {
    ...
    public static final Integer toIntExactOrNull(double $receiver) {
        ...
        if ($receiver < ((double) Integer.MIN_VALUE) || $receiver > d) {
            return null;
        }
        return Integer.valueOf((int) $receiver);
    }
    ...
    public static final Integer toIntExactOrNull(float $receiver) {
        ...
        if ($receiver < ((float) Integer.MIN_VALUE) || $receiver > f) {
            return null;
        }
        return Integer.valueOf((int) $receiver);
    }
    ...
    public static final Long toLongExactOrNull(double $receiver) {
        ...
        if ($receiver < ((double) Long.MIN_VALUE) || $receiver > d) {
            return null;
        }
    ...
    public static final Long toLongExactOrNull(float $receiver) {
        ...
        if ($receiver < ((float) Long.MIN_VALUE) || $receiver > f) {
            return null;
        }
        return Long.valueOf((long) $receiver);
    }
    ...
    public static final Short toShortExactOrNull(long $receiver) {
        long j = (long) 32767;
        if (((long) -32768) <= $receiver && j >= $receiver) {
    ...
    public static final Short toShortExactOrNull(double $receiver) {
        ...
        if ($receiver < ((double) -32768) || $receiver > d) {
            return null;
        }
        return Short.valueOf((short) ((int) $receiver));
    }
    ...
    public static final Short toShortExactOrNull(float $receiver) {
        float f = (float) 32767;
        if ($receiver < ((float) -32768) || $receiver > f) {
            return null;
        }
        return Short.valueOf((short) ((int) $receiver));
    }
    ...
    public static final int coerceIn(int $receiver, @NotNull ClosedRange<Integer> range) {
        Intrinsics.checkParameterIsNotNull(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((Number) RangesKt.coerceIn(Integer.valueOf($receiver), (ClosedFloatingPointRange) range)).intValue();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        } else if ($receiver < range.getStart().intValue()) {
            return range.getStart().intValue();
        } else {
            if ($receiver > range.getEndInclusive().intValue()) {
    ...
    public static final long coerceIn(long $receiver, @NotNull ClosedRange<Long> range) {
        Intrinsics.checkParameterIsNotNull(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((Number) RangesKt.coerceIn(Long.valueOf($receiver), (ClosedFloatingPointRange) range)).longValue();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        } else if ($receiver < range.getStart().longValue()) {
            return range.getStart().longValue();
        } else {
            if ($receiver > range.getEndInclusive().longValue()) {
