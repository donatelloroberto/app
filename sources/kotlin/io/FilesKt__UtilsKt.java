...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final java.io.File copyTo(@org.jetbrains.annotations.NotNull java.io.File r10, @org.jetbrains.annotations.NotNull java.io.File r11, boolean r12, int r13) {
        ...
        L_0x005a:
            ...
            r0 = r1
            java.io.FileInputStream r0 = (java.io.FileInputStream) r0     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            r7 = r0
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            r2.<init>(r11)     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            java.io.Closeable r2 = (java.io.Closeable) r2     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            r4 = 0
            java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            r0 = r2
            java.io.FileOutputStream r0 = (java.io.FileOutputStream) r0     // Catch:{ Throwable -> 0x0086 }
            r8 = r0
            java.io.InputStream r7 = (java.io.InputStream) r7     // Catch:{ Throwable -> 0x0086 }
            java.io.OutputStream r8 = (java.io.OutputStream) r8     // Catch:{ Throwable -> 0x0086 }
            kotlin.io.ByteStreamsKt.copyTo(r7, r8, r13)     // Catch:{ Throwable -> 0x0086 }
            kotlin.io.CloseableKt.closeFinally(r2, r4)     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
        ...
        L_0x0088:
            r5 = move-exception
            kotlin.io.CloseableKt.closeFinally(r2, r4)     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
            throw r5     // Catch:{ Throwable -> 0x008d, all -> 0x0096 }
        L_0x008d:
            r2 = move-exception
    ...
    public static final boolean copyRecursively(@NotNull File $receiver, @NotNull File target, boolean overwrite, @NotNull Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        if (!$receiver.exists()) {
            if (((OnErrorAction) onError.invoke($receiver, new NoSuchFileException($receiver, (File) null, "The source file doesn't exist.", 2, (DefaultConstructorMarker) null))) != OnErrorAction.TERMINATE) {
                return true;
            }
            return false;
        }
        try {
            ...
            while (it.hasNext()) {
                File src = it.next();
                if (!src.exists()) {
                    if (((OnErrorAction) onError.invoke(src, new NoSuchFileException(src, (File) null, "The source file doesn't exist.", 2, (DefaultConstructorMarker) null))) == OnErrorAction.TERMINATE) {
                        return false;
                    }
                } else {
                    ...
                    if (src.isDirectory()) {
                        dstFile.mkdirs();
                    } else if (FilesKt.copyTo$default(src, dstFile, overwrite, 0, 4, (Object) null).length() != src.length()) {
