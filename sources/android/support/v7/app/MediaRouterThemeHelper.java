...
final class MediaRouterThemeHelper {
    ...
    static Context createThemedContext(Context context, int style) {
        Context themedContext = new ContextThemeWrapper(context, getStyledRouterThemeId(context, style));
        int customizedThemeId = getThemeResource(context, R.attr.mediaRouteTheme);
        return customizedThemeId == 0 ? themedContext : new ContextThemeWrapper(themedContext, customizedThemeId);
    }
