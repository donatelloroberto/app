...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    public MediaRouteControllerDialog(Context context, int theme) {
        super(MediaRouterThemeHelper.createThemedContext(context, MediaRouterThemeHelper.getAlertDialogResolvedTheme(context, theme)), theme == 0 ? MediaRouterThemeHelper.createThemeForDialog(context, MediaRouterThemeHelper.getAlertDialogResolvedTheme(context, theme)) : theme);
    ...
    private class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public void onPostExecute(Bitmap art) {
            ...
            if (!ObjectsCompat.equals(this.this$0.mArtIconBitmap, this.mIconBitmap) || !ObjectsCompat.equals(this.this$0.mArtIconUri, this.mIconUri)) {
